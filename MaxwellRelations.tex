...
\geometry{margin=0.5cm}  % Márgenes de 1 pulgada

\begin{document}

\renewcommand{\arraystretch}{1.3}  % Ajuste del espaciado entre filas
\setlength{\tabcolsep}{10pt}       % Ajuste del espaciado entre columnas
\setlength{\arrayrulewidth}{0.5pt} % Grosor de las líneas
